...
## Statement 
The system shall preserve the previous usable EPUB version if metadata writing, cover replacement, or content editing fails.

## Rationale 
EPUB modification is a data-loss risk and must fail safely.
...
## More Information 
Related to [REQ-FUNC-007](./../functional/REQ-FUNC-007.md).
