...
## Statement 
The system shall expose a REST API for client-server communication.

## Rationale 
The agreed server direction is a REST server, and remote clients must communicate through the server rather than directly touching persistent storage.
...
## More Information 
The API specification should be published as OpenAPI or equivalent before v0.6.
