...
- More Information: Allowed relation types should be finalized during domain-model design. A potential, additional relationship is that between two series contained in the same spanning series.
