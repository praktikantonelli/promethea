...
## Statement
The system shall allow an authenticated user to edit book, edition, author, and series metadata stored in the catalog.

## Rationale
Manual correction is necessary because imported and provider-supplied metadata may be incomplete or incorrect.
...
## More Information
Field-level validation rules are TBD and should be refined during UI/API design.
