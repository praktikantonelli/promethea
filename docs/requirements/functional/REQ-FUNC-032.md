...
## Statement 
The system shall display job status and recent job history to authenticated users.

## Rationale 
Users need feedback for imports, metadata fetching, image fetching, EPUB editing, and sync workflows.
